...
###############------Channel Wise Attention Block(CWAB)------###############
...
def window_partition_triangular(x, window_size, masks):   #[1, 64, 64, 180]
    ...
    ''' Will update after acceptance of the paper'''
...
###################---------Rectangular Fusion Attention Block(RFAB)---------###################
...
class OCFAB(nn.Module):
    # Overlapping Cross Fusion Attention Block
...
###################---------Atten_Blocks(RFAB+OCFAB)---------###################
class AttenBlocks(nn.Module):
    """ A series of attention blocks for one RMAB.
    ...
    def __init__(self,
        ...
        ##RFAB
        self.blocks = nn.ModuleList([RFAB(dim=dim,
    ...
    def forward(self, x, x_size, params):  #[1, 4096, 180], (64, 64)
        ...
        x = self.overlap_attn(x, x_size, params['rpi_ocfa'])  #[1, 4096, 180]->[1, 4096, 180]
...
###################---------Residual Multi-Attention Block(RMAB)---------###################
class RMAB(nn.Module):
    """Residual Multi-Attention Block (RMAB).
...
class CFAT(nn.Module):
    ...
    def __init__(self,
        ...
        relative_position_index_OCFA = self.calculate_rpi_ocfa()
        self.register_buffer('relative_position_index_SA', relative_position_index_SA)
        self.register_buffer('relative_position_index_OCFA', relative_position_index_OCFA)
        ######----Relative_Position_Index----######
    ...
    ######----Relative_Position_Index_for_RFAB----######
    ...
    ######----Attention_Mask_for_RFAB(SW-MSA)----######
    ...
    def forward_features(self, x):  #[1, 180, 64, 64]
        ...
        params = {'attn_mask': attn_mask, 'triangular_masks': triangular_masks, 'rpi_sa': self.relative_position_index_SA, 'rpi_ocfa': self.relative_position_index_OCFA}
